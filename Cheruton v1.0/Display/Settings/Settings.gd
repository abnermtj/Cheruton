...
func _ready():
	...
	DataResource.connect("change_audio_master", self, "change_master_vol")
	DataResource.connect("change_audio_music", self, "change_music_vol")
	DataResource.connect("change_audio_sfx", self, "change_sfx_vol")
