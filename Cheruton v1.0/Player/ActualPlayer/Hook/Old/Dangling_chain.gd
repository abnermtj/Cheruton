...
# TO SETUP set the start end end pos of the rope and then call setup_chain()
# whe no used do remove_links()
#
...
var unit = load("res://Player/ActualPlayer/Hook/Old/Dangling_chain_unit.tscn")
